...
insert into employee(emp_id, gender, name, address, department, manager, age, position)
	values('A00001', 'Male', 'Moon', '10-199, Gang-nam, Seoul', 1, 'C00001', 30, 'Senior engineer');
insert into employee(emp_id, gender, name, address, department, manager, age, position)
	values('B00100', 'Female', 'Sun', '587/8, Gwan-ak, Seoul', 2, 'B00102', 25, 'Associate marketer');
insert into employee(emp_id, gender, name, address, department, manager, age, position)
	values('A08771', 'Others', 'Peach', '203-3, Guro, Seoul', 1, 'C00001', 26, 'Junior engineer');
insert into employee(emp_id, gender, name, address, department, manager, age, position)
	values('C00129', 'Male', 'Alex', '20-331, Bundang, Gyonggi', 3, 'C00002', 40, 'Director');
insert into employee(emp_id, gender, name, address, department, manager, age, position)
	values('C00001', 'Male', 'Lion', '53-3, Namyang-ju, Gyonghi', 1, 'C00000', 55, 'CTO');
insert into employee(emp_id, gender, name, address, department, manager, age, position)
	values('C00002', 'Others', 'Cindy', '100, Jong-ro, Seoul', 3, 'C00000',	52, 'Director');
insert into employee(emp_id, gender, name, address, department, manager, age, position)
	values('B00102', 'Female', 'Ran', '290-10, Gwanghwamun, Seoul',	2, 'C00000', 45, 'Director');
insert into employee(emp_id, gender, name, address, department, manager, age, position)
	values('C00000', 'Male', 'K', '1010, Sung-soo, Seoul', null, null, 51, 'CEO');
